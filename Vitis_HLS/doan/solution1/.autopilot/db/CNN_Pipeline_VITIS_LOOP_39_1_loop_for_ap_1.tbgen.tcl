set moduleName CNN_Pipeline_VITIS_LOOP_39_1_loop_for_ap_1
set isTopModule 0
...
set C_modelName {CNN_Pipeline_VITIS_LOOP_39_1_loop_for_ap_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ Weights int 32 regular {array 11065 { 1 1 } 1 1 }  }
	{ OutPadConv1 float 32 regular {array 1296 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ OutConv1 float 32 regular {array 1280 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "Weights", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPadConv1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutConv1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ OutPadConv1_address0 sc_out sc_lv 11 signal 1 } 
	{ OutPadConv1_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutPadConv1_q0 sc_in sc_lv 32 signal 1 } 
	{ OutPadConv1_address1 sc_out sc_lv 11 signal 1 } 
	{ OutPadConv1_ce1 sc_out sc_logic 1 signal 1 } 
	{ OutPadConv1_q1 sc_in sc_lv 32 signal 1 } 
	{ OutConv1_address0 sc_out sc_lv 11 signal 2 } 
	{ OutConv1_ce0 sc_out sc_logic 1 signal 2 } 
	{ OutConv1_we0 sc_out sc_logic 1 signal 2 } 
	{ OutConv1_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "address0" }} , 
 	{ "name": "OutPadConv1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "ce0" }} , 
 	{ "name": "OutPadConv1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "q0" }} , 
 	{ "name": "OutPadConv1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "address1" }} , 
 	{ "name": "OutPadConv1_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "ce1" }} , 
 	{ "name": "OutPadConv1_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv1", "role": "q1" }} , 
 	...
 	{ "name": "OutConv1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv1", "role": "d0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "14161", "Max" : "14161"}
	, {"Name" : "Interval", "Min" : "14161", "Max" : "14161"}
]}
...
set Spec2ImplPortList { 
	...
	OutPadConv1 { ap_memory {  { OutPadConv1_address0 mem_address 1 11 }  { OutPadConv1_ce0 mem_ce 1 1 }  { OutPadConv1_q0 mem_dout 0 32 }  { OutPadConv1_address1 MemPortADDR2 1 11 }  { OutPadConv1_ce1 MemPortCE2 1 1 }  { OutPadConv1_q1 MemPortDOUT2 0 32 } } }
	OutConv1 { ap_memory {  { OutConv1_address0 mem_address 1 11 }  { OutConv1_ce0 mem_ce 1 1 }  { OutConv1_we0 mem_we 1 1 }  { OutConv1_d0 mem_din 1 32 } } }
}
