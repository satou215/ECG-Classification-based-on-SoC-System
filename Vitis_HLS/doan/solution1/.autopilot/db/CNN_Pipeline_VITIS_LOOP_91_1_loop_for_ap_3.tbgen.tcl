set moduleName CNN_Pipeline_VITIS_LOOP_91_1_loop_for_ap_3
set isTopModule 0
...
set C_modelName {CNN_Pipeline_VITIS_LOOP_91_1_loop_for_ap_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ Weights int 32 regular {array 11065 { 1 1 } 1 1 }  }
	{ OutPadConv3 float 32 regular {array 1312 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ OutConv3 float 32 regular {array 1280 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "Weights", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPadConv3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutConv3", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv3", "role": "q0" }} , 
 	...
 	{ "name": "OutPadConv3_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv3", "role": "q1" }} , 
 	...
 	{ "name": "OutConv3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv3", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	OutPadConv3 { ap_memory {  { OutPadConv3_address0 mem_address 1 11 }  { OutPadConv3_ce0 mem_ce 1 1 }  { OutPadConv3_q0 mem_dout 0 32 }  { OutPadConv3_address1 MemPortADDR2 1 11 }  { OutPadConv3_ce1 MemPortCE2 1 1 }  { OutPadConv3_q1 MemPortDOUT2 0 32 } } }
	OutConv3 { ap_memory {  { OutConv3_address0 mem_address 1 11 }  { OutConv3_ce0 mem_ce 1 1 }  { OutConv3_we0 mem_we 1 1 }  { OutConv3_d0 mem_din 1 32 } } }
}
