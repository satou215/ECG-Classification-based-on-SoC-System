set moduleName CNN_Pipeline_VITIS_LOOP_195_1_loop_for_ap_7_loop_for_fc_7_loop_for_fa_7
set isTopModule 0
...
set C_modelName {CNN_Pipeline_VITIS_LOOP_195_1_loop_for_ap_7_loop_for_fc_7_loop_for_fa_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ Weights int 32 regular {array 11065 { 1 1 } 1 1 }  }
	{ OutPadConv7 float 32 regular {array 1408 { 1 3 } 1 1 }  }
	{ OutConv7 float 32 regular {array 1280 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "Weights", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPadConv7", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutConv7", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ OutPadConv7_address0 sc_out sc_lv 11 signal 1 } 
	{ OutPadConv7_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutPadConv7_q0 sc_in sc_lv 32 signal 1 } 
	{ OutConv7_address0 sc_out sc_lv 11 signal 2 } 
	{ OutConv7_ce0 sc_out sc_logic 1 signal 2 } 
	{ OutConv7_we0 sc_out sc_logic 1 signal 2 } 
	{ OutConv7_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv7_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv7", "role": "q0" }} , 
 	...
 	{ "name": "OutConv7_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv7", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_6ns_6ns_6ns_11_4_1_U100", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "819216", "Max" : "819216"}
	, {"Name" : "Interval", "Min" : "819216", "Max" : "819216"}
]}
...
set Spec2ImplPortList { 
	...
	OutPadConv7 { ap_memory {  { OutPadConv7_address0 mem_address 1 11 }  { OutPadConv7_ce0 mem_ce 1 1 }  { OutPadConv7_q0 mem_dout 0 32 } } }
	OutConv7 { ap_memory {  { OutConv7_address0 mem_address 1 11 }  { OutConv7_ce0 mem_ce 1 1 }  { OutConv7_we0 mem_we 1 1 }  { OutConv7_d0 mem_din 1 32 } } }
}
