...
set C_modelArgList {
	{ OutConv7 float 32 regular {array 1280 { 1 1 } 1 1 }  }
	{ OutPool3 float 32 regular {array 640 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "OutConv7", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPool3", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ OutConv7_address0 sc_out sc_lv 11 signal 0 } 
	{ OutConv7_ce0 sc_out sc_logic 1 signal 0 } 
	{ OutConv7_q0 sc_in sc_lv 32 signal 0 } 
	{ OutConv7_address1 sc_out sc_lv 11 signal 0 } 
	{ OutConv7_ce1 sc_out sc_logic 1 signal 0 } 
	{ OutConv7_q1 sc_in sc_lv 32 signal 0 } 
	{ OutPool3_address0 sc_out sc_lv 10 signal 1 } 
	{ OutPool3_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutPool3_we0 sc_out sc_logic 1 signal 1 } 
	{ OutPool3_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutConv7_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv7", "role": "q0" }} , 
 	...
 	{ "name": "OutConv7_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv7", "role": "q1" }} , 
 	...
 	{ "name": "OutPool3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPool3", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	OutConv7 { ap_memory {  { OutConv7_address0 mem_address 1 11 }  { OutConv7_ce0 mem_ce 1 1 }  { OutConv7_q0 in_data 0 32 }  { OutConv7_address1 MemPortADDR2 1 11 }  { OutConv7_ce1 MemPortCE2 1 1 }  { OutConv7_q1 in_data 0 32 } } }
	OutPool3 { ap_memory {  { OutPool3_address0 mem_address 1 10 }  { OutPool3_ce0 mem_ce 1 1 }  { OutPool3_we0 mem_we 1 1 }  { OutPool3_d0 mem_din 1 32 } } }
}
