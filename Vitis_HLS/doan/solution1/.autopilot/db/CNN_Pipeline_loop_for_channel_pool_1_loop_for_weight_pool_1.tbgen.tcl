...
set C_modelArgList {
	{ OutConv3 float 32 regular {array 1280 { 1 1 } 1 1 }  }
	{ OutPool1 float 32 regular {array 640 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "OutConv3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPool1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutConv3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv3", "role": "q0" }} , 
 	...
 	{ "name": "OutConv3_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv3", "role": "q1" }} , 
 	...
 	{ "name": "OutPool1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPool1", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	OutConv3 { ap_memory {  { OutConv3_address0 mem_address 1 11 }  { OutConv3_ce0 mem_ce 1 1 }  { OutConv3_q0 in_data 0 32 }  { OutConv3_address1 MemPortADDR2 1 11 }  { OutConv3_ce1 MemPortCE2 1 1 }  { OutConv3_q1 in_data 0 32 } } }
	OutPool1 { ap_memory {  { OutPool1_address0 mem_address 1 10 }  { OutPool1_ce0 mem_ce 1 1 }  { OutPool1_we0 mem_we 1 1 }  { OutPool1_d0 mem_din 1 32 } } }
}
