...
set C_modelArgList {
	{ OutPadConv6 float 32 regular {array 704 { 0 3 } 0 1 }  }
	{ OutPool2 float 32 regular {array 640 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "OutPadConv6", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "OutPool2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv6_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv6", "role": "d0" }} , 
 	...
 	{ "name": "OutPool2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPool2", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_6ns_6ns_10_4_1_U82", "Parent" : "0"},
...
set Spec2ImplPortList { 
	OutPadConv6 { ap_memory {  { OutPadConv6_address0 mem_address 1 10 }  { OutPadConv6_ce0 mem_ce 1 1 }  { OutPadConv6_we0 mem_we 1 1 }  { OutPadConv6_d0 mem_din 1 32 } } }
	OutPool2 { ap_memory {  { OutPool2_address0 mem_address 1 10 }  { OutPool2_ce0 mem_ce 1 1 }  { OutPool2_q0 in_data 0 32 } } }
}
