...
set name CNN_sitofp_32ns_32_4_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_Dense \
    op interface \
    ports { out_Dense_address0 { O 3 vector } out_Dense_ce0 { O 1 bit } out_Dense_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv6_i_out \
    op interface \
    ports { conv6_i_out { O 32 vector } conv6_i_out_ap_vld { O 1 bit } } \
} "
}
