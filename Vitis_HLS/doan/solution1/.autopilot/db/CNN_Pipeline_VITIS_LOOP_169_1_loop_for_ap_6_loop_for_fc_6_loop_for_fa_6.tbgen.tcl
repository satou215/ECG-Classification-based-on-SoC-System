set moduleName CNN_Pipeline_VITIS_LOOP_169_1_loop_for_ap_6_loop_for_fc_6_loop_for_fa_6
set isTopModule 0
...
set C_modelName {CNN_Pipeline_VITIS_LOOP_169_1_loop_for_ap_6_loop_for_fc_6_loop_for_fa_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ Weights int 32 regular {array 11065 { 1 1 } 1 1 }  }
	{ OutPadConv6 float 32 regular {array 704 { 1 3 } 1 1 }  }
	{ OutConv6 float 32 regular {array 1280 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "Weights", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutPadConv6", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "OutConv6", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ OutPadConv6_address0 sc_out sc_lv 10 signal 1 } 
	{ OutPadConv6_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutPadConv6_q0 sc_in sc_lv 32 signal 1 } 
	{ OutConv6_address0 sc_out sc_lv 11 signal 2 } 
	{ OutConv6_ce0 sc_out sc_logic 1 signal 2 } 
	{ OutConv6_we0 sc_out sc_logic 1 signal 2 } 
	{ OutConv6_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv6_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv6", "role": "q0" }} , 
 	...
 	{ "name": "OutConv6_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutConv6", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_6ns_6ns_10_4_1_U89", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "409616", "Max" : "409616"}
	, {"Name" : "Interval", "Min" : "409616", "Max" : "409616"}
]}
...
set Spec2ImplPortList { 
	...
	OutPadConv6 { ap_memory {  { OutPadConv6_address0 mem_address 1 10 }  { OutPadConv6_ce0 mem_ce 1 1 }  { OutPadConv6_q0 mem_dout 0 32 } } }
	OutConv6 { ap_memory {  { OutConv6_address0 mem_address 1 11 }  { OutConv6_ce0 mem_ce 1 1 }  { OutConv6_we0 mem_we 1 1 }  { OutConv6_d0 mem_din 1 32 } } }
}
