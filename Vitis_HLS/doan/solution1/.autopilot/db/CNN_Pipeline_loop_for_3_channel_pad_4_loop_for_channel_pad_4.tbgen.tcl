...
set C_modelArgList {
	{ OutPadConv4 float 32 regular {array 672 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ OutPool1 float 32 regular {array 640 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "OutPadConv4", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "OutPool1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ OutPadConv4_address0 sc_out sc_lv 10 signal 0 } 
	{ OutPadConv4_ce0 sc_out sc_logic 1 signal 0 } 
	{ OutPadConv4_we0 sc_out sc_logic 1 signal 0 } 
	{ OutPadConv4_d0 sc_out sc_lv 32 signal 0 } 
	{ OutPool1_address0 sc_out sc_lv 10 signal 1 } 
	{ OutPool1_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutPool1_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv4_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv4", "role": "d0" }} , 
 	...
 	{ "name": "OutPool1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPool1", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_4ns_7ns_7ns_10_4_1_U55", "Parent" : "0"},
...
set Spec2ImplPortList { 
	OutPadConv4 { ap_memory {  { OutPadConv4_address0 mem_address 1 10 }  { OutPadConv4_ce0 mem_ce 1 1 }  { OutPadConv4_we0 mem_we 1 1 }  { OutPadConv4_d0 mem_din 1 32 } } }
	OutPool1 { ap_memory {  { OutPool1_address0 mem_address 1 10 }  { OutPool1_ce0 mem_ce 1 1 }  { OutPool1_q0 in_data 0 32 } } }
}
