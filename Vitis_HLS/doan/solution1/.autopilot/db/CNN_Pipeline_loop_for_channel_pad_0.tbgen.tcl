...
set C_modelArgList {
	{ OutPadConv0 float 32 regular {array 324 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ InModel int 32 regular {array 320 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "OutPadConv0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "OutPadConv0", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	OutPadConv0 { ap_memory {  { OutPadConv0_address0 mem_address 1 9 }  { OutPadConv0_ce0 mem_ce 1 1 }  { OutPadConv0_we0 mem_we 1 1 }  { OutPadConv0_d0 mem_din 1 32 } } }
	InModel { ap_memory {  { InModel_address0 mem_address 1 9 }  { InModel_ce0 mem_ce 1 1 }  { InModel_q0 in_data 0 32 } } }
}
