...
void Max_Pool1D_0(float input_MaxPooling[1280], float output_MaxPooling[640]){
 ...
 for (int z = 0; z < 4; z++){
  ...
  for (int y = 0; y < 160; y++){
   float max = -10;
   VITIS_LOOP_11_1: for (int j = 0; j < PoolSize; j++)
   {
...
void Max_Pool1D_1(float input_MaxPooling[1280], float output_MaxPooling[640]){
 ...
 for (int z = 0; z < 8; z++){
  ...
  for (int y = 0; y < 80; y++){
   float max = -10;
   VITIS_LOOP_33_1: for (int j = 0; j < PoolSize; j++)
   {
...
void Max_Pool1D_2(float input_MaxPooling[1280], float output_MaxPooling[640]){
 ...
 for (int z = 0; z < 16; z++){
  ...
  for (int y = 0; y < 40; y++){
   float max = -10;
   VITIS_LOOP_55_1: for (int j = 0; j < PoolSize; j++)
   {
...
void Max_Pool1D_3(float input_MaxPooling[1280], float output_MaxPooling[640]){
 ...
 for (int z = 0; z < 32; z++){
  ...
  for (int y = 0; y < 20; y++){
   float max = -10;
   VITIS_LOOP_77_1: for (int j = 0; j < PoolSize; j++)
   {
...
void Global_Average_Pool1D_4(float input_GlobalAveragePooling[640], float output_GlobalAveragePooling[32]){
 ...
 for (int z = 0; z < 32; z++){
  float Average = 0;
  float pool_value = 0;
  VITIS_LOOP_95_1: for (int j = 0; j < 32; j++)
  {
