...
def train():
    ...
    avg_train_loss = []
    avg_val_loss = []
    with open('C:\\Users\\satou\\Downloads\\Compressed\\mit_bih-20240413T160844Z-001\\mit_bih\\results\\log_val_cf.csv', 'w') as f:
        pass
    for epoch in range(EPOCHS):
        ...
        with open('C:\\Users\\satou\\Downloads\\Compressed\\mit_bih-20240413T160844Z-001\\mit_bih\\results\\log_val_cf.csv', 'a') as f:
            writer = csv.writer(f)
        ...
        if max_f1 < F1[-1]:
            ...
            torch.save({
                ...
                'history': H,
            }, os.path.join(os.getcwd(), f'C:\\Users\\satou\\Downloads\\Compressed\\mit_bih-20240413T160844Z-001\\mit_bih\\training\\max_checkpoint.pth'))
        ...
        torch.save({
            ...
            'optimizer_state_dict': optimizer.state_dict(),
            'history': H,
        }, os.path.join(os.getcwd(), f'C:\\Users\\satou\\Downloads\\Compressed\\mit_bih-20240413T160844Z-001\\mit_bih\\training\\checkpoint_{epoch + 1}.pth'))
